...
<head>
    ...
    <title>Expense Status Update - EduManage</title>
    <style>
        /* Modern Reset */
        ...
        .amount-value { font-size: 18px; color: #1A2332; font-weight: 800; }
        ...
        <table class="main-container" role="presentation">
            ...
            <tr>
                <td class="header">
                    ...
                    <p class="brand-subtitle">Financial Update</p>
                </td>
            </tr>
            ...
            <tr>
                <td class="content">
                    ...
                    <p class="message">
                        Your expense request status has been updated.
                    </p>
                    ...
                    <div class="card">
                        <div class="field-group">
                            ...
                            <span class="field-value">{{ $details['category'] }}</span>
                        </div>
                        <div class="field-group">
                            <span class="field-label">Amount</span>
                            <span class="field-value amount-value">Rs. {{ $details['amount'] }}</span>
                        </div>
                        <div class="field-group">
                    ...
                    <div class="remarks-box">
                        <span class="remarks-label">Note from Finance</span>
